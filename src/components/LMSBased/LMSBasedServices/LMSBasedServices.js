import style from "./LMSBasedServices.module.scss";
import { BsChevronRight } from "react-icons/bs";
import { Card, Grid } from "@mui/material";
import { useState } from "react";

function LMSBasedServices({ apiData }) {
    ...
    <div className={style.solve}>
      ...
      <div className={style.solve__identity}>
        <div className={style.head}>
          <p>{apiData.LmsSolutionSection.Title1}</p>
          <h2>
            <div>{apiData.LmsSolutionSection.Title2}</div>
            <div>{apiData.LmsSolutionSection.Title3}</div>
            <div className={style.headMobile}>
              {apiData.LmsSolutionSection.Title2}{" "}
              {apiData.LmsSolutionSection.Title2}{" "}
              {apiData.LmsSolutionSection.Title3}
            </div>
          </h2>
        </div>
        <div className={style.text}>
          <p>{apiData.LmsSolutionSection.Paragraph}</p>
          <p>
